      ...
      <div class="footer-widgets-wrapper">
        <div class="container">
          <div class="row">
            ...
            >
              <div class="single-footer-widget">
                <div class="widget-head">
                  <a href="index.php">
                    <img
                      src="assets/img/logo/Aerostack-Systems-Private-Limited-white.png"
                      alt="logo-img"
                    />
                  </a>
                </div>
                <div class="footer-content">
                  <p>
                    Anand Milan Complex, <br />
                    Opp Navrangpura Jain Derasar, <br />
                  ...
                  <ul class="contact-info">
                    ...
                    <li>
                      ...
                      <a href="mailto:info@aero-stack.com"
                        >info@aero-stack.com</a
                      >
                    </li>
                  </ul>
                </div>
            ...
            <div
              class="col-xl-2 col-lg-4 col-md-3 ps-lg-3 wow fadeInUp"
              data-wow-delay=".4s"
            >
              <div class="single-footer-widget">
                <div class="widget-head">
            ...
            <div
              class="col-xl-2 col-lg-4 col-md-3 ps-lg-4 wow fadeInUp"
              data-wow-delay=".6s"
            >
            ...
            <div
              class="col-xl-2 col-lg-4 col-md-6 ps-lg-4 wow fadeInUp"
              data-wow-delay=".8s"
            >
              <div class="single-footer-widget">
                <div class="widget-head">
            ...
            <div
              class="col-xl-3 col-lg-4 col-md-6 ps-lg-4 wow fadeInUp"
              data-wow-delay=".9s"
            >
              <div class="single-footer-widget">
                <div class="widget-head">
